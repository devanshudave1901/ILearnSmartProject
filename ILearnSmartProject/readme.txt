...
- xUnit for unit tests (project includes tests using xUnit by default)
...
1. Repository pattern
   - Used to abstract data access and communicate with the database via repository interfaces and implementations. Application services call repository methods for persistence operations. (Reference: https://www.geeksforgeeks.org/system-design/repository-design-pattern/)
2. Adapter pattern
...
Note on MVC vs Razor Pages
--------------------------
- Although parts of the planned architecture reference MVC concepts, the project is implemented as a Razor Pages application. MVC is acknowledged as an architectural approach but not counted as one of the three design patterns used to satisfy the requirements.

Functional requirements
-----------------------
- Users can create and log in to accounts.
- Users can view the appropriate list of available courses with descriptions and prices.
- Users can register for a selected course.
